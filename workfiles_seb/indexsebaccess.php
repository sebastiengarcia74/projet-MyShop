        ...
        <div id="header_right">
            ...
            <div id="header_right_bottom">
                    <div id="nav_bar_search">
                        ...
                        <input id="search_input" type="text" name="query" placeholder="Search..." aria-label="Search">
                ...
                <button type="button" class="filter_collapse">Filters</button> 
                    ...
                    <div class="filter_item_collapse">
                        ...
                        <div class="body_filter_range">
                            <input id="minV" type="range" class="min-price"  value="50" min="50" max="10000" step="50" aria-label="minimum price">
                            <input id="maxV" type="range" class="max-price" value="10000" min="50" max="10000" step="50" aria-label="maximum price">
                          </div>
